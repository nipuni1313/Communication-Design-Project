...
class mpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        for c in range(2, 3):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self._freq_range = Range(433e6, 533e6, 100e3, 433e6, 200)
        ...
        self.soapy_bladerf_source_0.set_sample_rate(0, 3200000)
        self.soapy_bladerf_source_0.set_bandwidth(0, 200000)
        ...
        self.soapy_bladerf_sink_0 = soapy.sink(dev, "fc32", 1, '',
                                  stream_args, tune_args, settings)
        self.soapy_bladerf_sink_0.set_sample_rate(0, 3200000)
        self.soapy_bladerf_sink_0.set_bandwidth(0, 200000)
