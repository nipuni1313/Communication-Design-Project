...
class transmitter_top(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "transmitter_top")
        ...
        self.digital_psk_demod_0 = digital.psk.psk_demod(
            ...
            verbose=False,
            log=False)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf((sps*1.00), (62.8e-3), rrc_taps, 32, 16, 1.5, 1)
...
def main(top_block_cls=transmitter_top, options=None):
