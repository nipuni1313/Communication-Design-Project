...
class fileRead(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fileRead")
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            '/media/prabathbk/EDUCATION/Acedemics/Sem 3/Com design project/Project/Test files/testFIle.py',
            1,
            samp_rate,
            blocks.FORMAT_WAV,
...
def main(top_block_cls=fileRead, options=None):
